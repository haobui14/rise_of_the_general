...
async function seed() {
  ...
  const itemsData = [
...

    {
      ...
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.25, destinyInteraction: 'heaven-favored' as const },
      lore: 'The blade said to answer only to a righteous warrior.',
      statBonus: { strength: 22, leadership: 8 },
    },
    {
      name: 'Serpent Spear',
      type: 'weapon' as const,
      rarity: 'mythic' as const,
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.2, destinyInteraction: 'neutral' as const },
      lore: 'A spear that howls like a serpent in stormwind.',
      statBonus: { strength: 20, speed: 6 },
    },
    {
      ...
      rarity: 'mythic' as const,
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.22, destinyInteraction: 'heaven-favored' as const },
      lore: 'Forged beneath meteors and imperial vows.',
      statBonus: { strength: 18, strategy: 8, leadership: 8 },
    },
    {
      name: 'Sky Scorcher Bow',
      type: 'weapon' as const,
      rarity: 'mythic' as const,
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.18, destinyInteraction: 'neutral' as const },
      lore: 'Flames trail every shot in legend and fear.',
      statBonus: { strength: 16, speed: 12 },
    },
    {
      name: 'Mandate of Heaven Armor',
      type: 'armor' as const,
      rarity: 'mythic' as const,
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.1, destinyInteraction: 'heaven-favored' as const },
      lore: 'Armor blessed by omens and dynastic rites.',
      statBonus: { defense: 22, leadership: 10 },
    },
    {
      name: 'Burning Phoenix Robes',
      type: 'armor' as const,
      rarity: 'mythic' as const,
      isMythic: true,
      duelBonus: { strengthMultiplier: 1.12, destinyInteraction: 'doomed' as const },
      lore: 'Robes woven with ash from vanished kingdoms.',
      statBonus: { defense: 14, strategy: 12, leadership: 6 },
    },
  ];
